...
def get_percentiles(x_digest: Any, y_digest: Any, z_digest: Any) -> List[Tuple[float, float]]:
    """
    Get the 0.01 and 99.99 percentiles for x, y, z dimensions.

    :param x_digest: Statistical t_digest object with a percentile method for x-dimension.
    :param y_digest: Statistical t_digest object with a percentile method for y-dimension.
    :param z_digest: Statistical t_digest object with a percentile method for z-dimension.
    :return: A list of tuples containing the percentiles for each dimension.
    """
    percentiles = [
        (x_digest.percentile(0.01), x_digest.percentile(99.99)),
